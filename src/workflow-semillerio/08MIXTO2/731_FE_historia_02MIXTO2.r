...
PARAM  <- list()
PARAM$experimento <- "FE7310_08"

PARAM$exp_input  <- "DR7210_08"
...
PARAM$RandomForest$semilla  <- 324161    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 413411   # cambiar por la propia semilla
