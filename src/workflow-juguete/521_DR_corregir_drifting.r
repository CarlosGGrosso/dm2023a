...
#PARAM$metodo  <- "rank_cero_fijo" MODIFICADO
PARAM$metodo  <- "deflacion" # AGREGADO
...
#setwd("~/buckets/b1") MODIFICADO
setwd("C:/Users/JM358/Documents/ITBA DATA CIENCE/CD.03 Mineria de Datos")
