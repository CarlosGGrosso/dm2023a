...
PARAM <- list()
PARAM$experimento  <- 32105
PARAM$semilla  <- 324161      #Establezco la semilla aleatoria, cambiar por SU primer semilla

#parameetros rpart
PARAM$rpart_param   <- list( 
#"cp"= -1, "minsplit"= 50, "minbucket"= 20, "maxdepth"= 8 #CORRIDA_1
#"cp"= -1, "minsplit"= 100, "minbucket"= 20, "maxdepth"= 6 #CORRIDA_2
#"cp"= -1, "minsplit"= 250, "minbucket"= 20, "maxdepth"= 10 #CORRIDA_3
#"cp"= -1, "minsplit"= 500, "minbucket"= 5, "maxdepth"= 8 #CORRIDA_4
"cp"= -1, "minsplit"= 500, "minbucket"= 100, "maxdepth"= 14 #CORRIDA_5
#"cp"= -1, "minsplit"= 750, "minbucket"= 10, "maxdepth"= 10 #CORRIDA_6
#"cp"= -1, "minsplit"= 750, "minbucket"= 100, "maxdepth"= 6 #CORRIDA_7
#"cp"= -1, "minsplit"= 1000, "minbucket"= 20, "maxdepth"= 14 #CORRIDA_8
#"cp"= -1, "minsplit"= 1000, "minbucket"= 200, "maxdepth"= 8 #CORRIDA_9
  )
